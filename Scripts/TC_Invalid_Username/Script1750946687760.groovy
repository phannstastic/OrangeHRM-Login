...
WebUI.verifyElementVisible(findTestObject('Object Repository/Page_OrangeHRM/h5_Login'), FailureHandling.STOP_ON_FAILURE)

WebUI.setText(findTestObject('Object Repository/Page_OrangeHRM/input_Username_username'), 'Adm')
